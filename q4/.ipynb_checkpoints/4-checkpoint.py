...
def perfTest(queue_size=1000):
    ...
    # listen on h8
    h1.cmd("iperf3 -s -i 1 > " + "2hop_" + str(queue_size) + "_cubic &")
    h2.cmd("iperf3 -s -i 1 > " + "2hop_" + str(queue_size) + "_bbr &")
    time.sleep(2)
    # start test on h1
    h3.cmd("iperf3 -c 10.0.0.1 -i 1 -t 300 -C cubic > " + "2hop_" + str(queue_size) + "_cubic_sender &")
    time.sleep(50)
    h4.cmd("iperf3 -c 10.0.0.2 -i 1 -t 200 -C bbr > " + "2hop_" + str(queue_size) + "_bbr_sender &")
...
if __name__ == '__main__':
    ...
    for queue_size in range(0,100,4):
