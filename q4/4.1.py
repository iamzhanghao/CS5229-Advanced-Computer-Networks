...
def perfTest(queue_size=1000):
    ...
    # listen on h8
    h1.cmd("iperf3 -s -i 1 > " + "4hop_" + str(queue_size) + "_cubic &")
    h2.cmd("iperf3 -s -i 1 > " + "4hop_" + str(queue_size) + "_bbr &")
    time.sleep(2)
    # start test on h1
    h7.cmd("iperf3 -c 10.0.0.1 -i 1 -t 300 -C cubic > " + "4hop_" + str(queue_size) + "_cubic_sender &")
    time.sleep(50)
    h8.cmd("iperf3 -c 10.0.0.2 -i 1 -t 200 -C bbr > " + "4hop_" + str(queue_size) + "_bbr_sender &")
