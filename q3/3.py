...
def perfTest(mode="cubic",delay=10):
    ...
    # listen on h8
    h1.cmd("iperf3 -s -i 1 > " + mode + "_" + str(delay) + "_flow1 &")
    h4.cmd("iperf3 -s -i 1 > " + mode + "_" + str(delay) + "_flow2 &")
    time.sleep(2)
    # start test on h1
    h8.cmd("iperf3 -c 10.0.0.1 -i 1 -t 300 -C " + mode + " > " + mode + "_" + str(delay) + "_flow1_sender &")
    time.sleep(10)
    h8.cmd("iperf3 -c 10.0.0.4 -i 1 -t 300 -C " + mode + " > " + mode + "_" + str(delay) + "_flow2_sender &")
...
if __name__ == '__main__':
    ...
    for delay in range(100,1000,100):
